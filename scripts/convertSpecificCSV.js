...
// Fonction pour lire et parser le fichier CSV spécifique
function parseSpecificCSV(filePath) {
...
function main() {
  ...
  if (!csvFilePath) {
    console.log('Usage: node convertSpecificCSV.js <chemin-vers-fichier-csv>');
    console.log('Exemple: node convertSpecificCSV.js "./bdd complete v2.csv"');
    return;
  }
  ...
  try {
    ...
    const csvData = parseSpecificCSV(csvFilePath);
...
module.exports = { parseSpecificCSV, convertToTypeScript }; 