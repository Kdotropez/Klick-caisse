                  ...
                  return (
                    <Paper
                      ...
                      sx={{
                        ...
                        border: `1px solid ${categoryColor}`, // Bordure plus fine
                        borderRadius: `8px`, // Coins arrondis
                        boxShadow: `0 1px 2px rgba(0,0,0,0.1)`, // Ombre plus légère
             ...
             <Box sx={{ p: 0.5, flexGrow: 1, display: 'flex', flexDirection: 'column', gap: 0.5 }}>
               ...
               <Box sx={{ display: 'flex', gap: 0.5 }}>
                 ...
                 <Button
                   ...
                   onClick={() => console.log('Total Espèces')}
                 >
                   Total Espèces
                 </Button>
                 ...
                 <Button
                   ...
                   onClick={() => console.log('Total SumUp')}
                 >
                   Total SumUp
                 </Button>
                 ...
                 <Button
                   ...
                   onClick={() => console.log('Total Carte')}
                 >
                   Total Carte
                 </Button>
               </Box>
